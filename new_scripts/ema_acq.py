...
os.environ['EPICS_CA_SERVER_PORT']='5065'
...
class Acquisition(QtWidgets.QMainWindow):
    ...
    def connect_to_tdc(self):
        ...
        for i in range(0,4):
            ...
            self.tagger.set_channel_window(i,start = int(self.tdc_start.value()*4000),stop = self.tdc_stop.value()*4000) # 1000*2000 is 1 ms after trig
